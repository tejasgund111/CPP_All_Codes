...
// using std::stack fo stack implementation
stack<char> st;

// initializing a string to stor result of reversed stack
string ns;

// Below is a recursive functio that inserts an elemen at the bottom of a stack.
...
// Below is the function tha reverses the given stack usin insert_at_bottom()
void reverse()
{
	if(st.size()>0)
	{
