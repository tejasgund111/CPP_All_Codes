// C++ implementation of FIFO page replacement in Operating Systems.
#include <bits/stdc++.h>
using namespace std;
...
int main()
{
    ...
    int n = sizeof(pages) / sizeof(pages[0]); // size of the array means actually page string length
